...
-- Change description: Fix for a negative unittest failure for Website.InsertCustomerOrderr
-- Associated unittest: https://raw.githubusercontent.com/erickangMSFT/wwi-test/master/spec/website/insertCustomerOrder.rb 
--                      'fails for invalid orderlines'
-- Change date: 2017/09/15
-- Author: Eric Kang

ALTER PROCEDURE [Website].[InsertCustomerOrders]
